...
<?php if ( have_comments() ) : ?>
  <h3 id="comments"><?php comments_number('Comments so far', 'One Response', '% Responses' );?></h3>
...
<section id="respond">
  ...
  <h3><?php comment_form_title( 'Join the conversation', 'Leave a Reply to %s' ); ?></h3>
...
<ul class="contactForm">
  ...
  <?php else : ?>
	  ...
	  <li>
	    <label class="twoLines" for="email">Email <br /><small>Will not be published</small></label>
	  ...
	  <li>
	    <label for="url" class="notRequired">Website</label>
